...
import pjcdkassets from "cdk-assets/package.json" assert { type: 'json' };
import { AssetManifest } from "cdk-assets";
import { debug, warning } from "sst-aws-cdk/lib/logging.js";
import pj from "sst-aws-cdk/package.json" assert { type: 'json' };
...
export class Deployments {
    ...
    async deployStack(options) {
        ...
        console.log('')
        console.log('In sst, requiring cdk-assets', pj.devDependencies['cdk-assets'])
        console.log('In sst, getting cdk-assets', pjcdkassets.version)
