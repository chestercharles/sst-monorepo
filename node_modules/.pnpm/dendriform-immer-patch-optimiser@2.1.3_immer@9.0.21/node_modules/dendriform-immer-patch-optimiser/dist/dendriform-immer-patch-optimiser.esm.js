import { enablePatches, nothing, applyPatches as applyPatches$1 } from 'immer';
...
var optimiseArray = function optimiseArray(base, patches) {
  ...
  if (patches.length === 1 && patches[0].path.length === 0) {
    ...
    targetIds = applyPatches$1(baseIds, replacedPatches);
...
var applyPatches = function applyPatches(base, patches) {
  patches.forEach(function (patch) {
    if (patch.op === 'move') {
      ...
      base = applyPatches$1(base, [patch]);
    }
  });
  return base;
};

export { ARRAY, BASIC, MAP, OBJECT, SET, applyPatches, clone, create, entries, get, getIn, getType, has, optimise, optimiseArray, set, zoomInPatches, zoomOutPatches };
//# sourceMappingURL=dendriform-immer-patch-optimiser.esm.js.map
