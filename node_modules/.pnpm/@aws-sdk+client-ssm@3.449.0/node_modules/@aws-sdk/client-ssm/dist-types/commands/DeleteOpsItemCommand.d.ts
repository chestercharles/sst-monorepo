 ...
 *
 */
export declare class DeleteOpsItemCommand extends $Command<DeleteOpsItemCommandInput, DeleteOpsItemCommandOutput, SSMClientResolvedConfig> {
    readonly input: DeleteOpsItemCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: DeleteOpsItemCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: SSMClientResolvedConfig, options?: __HttpHandlerOptions): Handler<DeleteOpsItemCommandInput, DeleteOpsItemCommandOutput>;
    /**
     * @internal
     */
    private serialize;
