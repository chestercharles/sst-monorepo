...
var nodeHTTPRequestHandler = require('./nodeHTTPRequestHandler-7325b53f.cjs.prod.js');
...
nodeHTTPRequestHandler.assertNotBrowser();
...
class Router {
  ...
  getErrorShape(opts) {
    ...
    const shape = {
      ...
      data: {
        code,
        httpStatus: nodeHTTPRequestHandler.getHTTPStatusCodeFromError(error)
      }
    };
...
exports.assertNotBrowser = nodeHTTPRequestHandler.assertNotBrowser;
exports.resolveHTTPResponse = nodeHTTPRequestHandler.resolveHTTPResponse;
